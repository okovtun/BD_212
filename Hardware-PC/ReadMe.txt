https://github.com/okovtun/BD_212.git
...
Overclocking:
https://www.youtube.com/watch?v=ftS3lnapjXg&t=1s

TODO:
Используя программу AIDA-64 измерить производительность кэша и памяти.
В журнал прислать скрин теста.

DONE:
Используя программу CPU-Z определить дополнительные наборы команд своего CPU.
...
Выяснить, какое напряжение питания используется для разных поколений памяти,
а так же, по какому техпроцессу выполнены микросхемы разных поколений памяти.
